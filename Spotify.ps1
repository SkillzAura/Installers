...
iex "& { $(iwr -useb 'https://raw.githubusercontent.com/SkillzAura/Installers/refs/heads/main/SpotX.ps1') } -confirm_uninstall_ms_spoti -confirm_spoti_recomended_uninstall -podcasts_off -adsections_off -block_update_on -lyrics_stat purple -old_lyrics -cache_limit 500 -no_shortcut -DisableStartup"
